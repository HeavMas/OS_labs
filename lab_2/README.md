...
5. Зайдите на 192.168.11.113,  должен перенаправлять на сайт с именем web1 и web2

## Содержание ##
----------------
### inventory ###
-----------------
Содержит переменные, которые можно использовать во всем плейбуке
### nginx.yml ###
-----------------
...
### roles balanser ###
----------------------
Проводится настройка балансировщика, на него устанавливается nginx и меняется конфиг файл, на файл из папки tamplates. 
